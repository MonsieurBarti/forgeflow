 ...
 *           resolve-phase, detect-build-test, implementation-preview,
...
// Attach to module.exports for programmatic access by command handlers
module.exports.generatePlanReviewHTML = generatePlanReviewHTML;
